...
class FilterWindow(QtWidgets.QWidget):
    ...
    def set_values(self,
        ...
        self.setField_wavelength_filter1.setValidator(self.validator.intValidator)
        self.setField_exposure_filter1.setText(exposure_filter1)
        self.setField_exposure_filter1.setValidator(self.validator.intValidator)
        ...
        self.setField_wavelength_filter2.setValidator(self.validator.intValidator)
        self.setField_exposure_filter2.setText(exposure_filter2)
        self.setField_exposure_filter2.setValidator(self.validator.intValidator)
        ...
        self.setField_wavelength_filter3.setValidator(self.validator.intValidator)
        self.setField_exposure_filter3.setText(exposure_filter3)
        self.setField_exposure_filter3.setValidator(self.validator.intValidator)
        ...
        self.setField_wavelength_filter4.setValidator(self.validator.intValidator)
        self.setField_exposure_filter4.setText(exposure_filter4)
        self.setField_exposure_filter4.setValidator(self.validator.intValidator)
        ...
        self.setField_wavelength_filter5.setValidator(self.validator.intValidator)
        self.setField_exposure_filter5.setText(exposure_filter5)
        self.setField_exposure_filter5.setValidator(self.validator.intValidator)
        ...
        self.setField_wavelength_filter6.setValidator(self.validator.intValidator)
        self.setField_exposure_filter6.setText(exposure_filter6)
        self.setField_exposure_filter6.setValidator(self.validator.intValidator)
