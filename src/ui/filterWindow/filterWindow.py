...
class FilterWindow(QtWidgets.QWidget):
    ...
    def set_values(self,
        ...
        self.setField_exposure_filter1.setValidator(self.validator.filter_intValidator)
        ...
        self.setField_exposure_filter2.setValidator(self.validator.filter_intValidator)
        ...
        self.setField_exposure_filter3.setValidator(self.validator.filter_intValidator)
        ...
        self.setField_exposure_filter4.setValidator(self.validator.filter_intValidator)
        ...
        self.setField_exposure_filter5.setValidator(self.validator.filter_intValidator)
        ...
        self.setField_exposure_filter6.setValidator(self.validator.filter_intValidator)
