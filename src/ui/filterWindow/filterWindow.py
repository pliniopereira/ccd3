...
class FilterWindow(QtWidgets.QWidget):
    ...
    def set_values(self,
        ...
        self.setField_exposure_filter2.setValidator(QIntValidator(0, 360))
        ...
        self.setField_exposure_filter3.setValidator(QIntValidator(0, 360))
        ...
        self.setField_exposure_filter4.setValidator(QIntValidator(0, 360))
        ...
        self.setField_exposure_filter5.setValidator(QIntValidator(0, 360))
        ...
        self.setField_exposure_filter6.setValidator(QIntValidator(0, 360))
